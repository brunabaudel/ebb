...
/// Doctor-ready summary preview and PDF export body, shared by Care and pushed settings.
struct DoctorExportContent: View {
...
#Preview("With data") {
    ...
    return DoctorExportContent(schema: schema)
...
#Preview("Empty") {
    DoctorExportContent(schema: try! SchemaConfig.load())
        .padding(.horizontal, 20)
